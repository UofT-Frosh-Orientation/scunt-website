export const JUDGES_DATA = [
    ...
    },
    {
       ...
       "Take of video of someone formally presenting a can of Heinz Baked Beans (obviously pork & molasses) to Scunt Chair, Erika Narimatsu",
        ...
        "Write an original poem (that rhymes) which contains the words “Godiva”, “Skule”, “Jackhammer”, “Sausage”, “Doggie” and “Moist” and read it to me", 
        "I might get hungry… a perfectly ripe avocado will do"],
       ...
       "A BEvERage. Bonus points if it’s one of my fav kinds — ask around, I’ve told people.",
        "Bring me a zine." ],
       ...
       "I’ll give brownies points to every Frosh who’s a Taurus", 
       "Finally, I’m looking to put some yee in my haw this year 🤠.  If it helps, i’m a 7.5-8 women shoes."],
       ...
       "ThE mOrE cAfFeInE, tHe BeTtEr!!! Just putting it out there for you 😉 ", 
       "Recite WAP like it is an excerpt from Shakespere. Bonus points for getting into character. ", 
       " Literally any food with chicken in it!🍗 "],
       ...
       
       {
        ...
        content : 
       [ "Give me anything Pokémon related. Stuffies, games, a swaggy pose next to an AR Pokémon – anything.", 
       ...
       
       {
        ...
        content : 
       [ "I like sports (particularly hockey and anything olympics), find me an obscure/cool fact I don’t know puhleez", 
       "Cheetos are my bane… but not the puffs… screw those", 
       "Pictures of bridges? If you’re in them, even better. Also, let’s see some colour correction plz", 
       "Learn and perform the Soulja Boy dance (hint: the song is titled “Crank That”.) The more people you can get to accompany you the better", 
       "As you can tell, my mullet is my best feature. Twin with me and then we’ll talk.", 
       "You ever heard of a whiskey sour? Yeah… yes please!", 
       "Retro is a vibe, I must say", 
       "Get me Michael Zolis’s right or left shoe WITH CONSENT. He’ll be around… p.s. He’s more likely to say yes if you ask for an exchange of goods" ],
    ...
    {  name: "Hannah Kot",
       ...
       "I really like wearing funky socks (I’m a men’s size 12 shoe btw).", 
       ...
       
       {
        ...
        content : 
       [ "Challenge and win a heel clicking contest against Godiva’s Crown", 
       ...
       "Direct my next IG post (down to the caption!) 🤠", 
       "Record and post a tik tok challenge of your choice with me", 
       "I love computer...sometimes I wish I was one….help me get one step closer to my dream", 
       "Say a sentence in Amazigh for me 🇩🇿", "Bring me your best thrift find that’s under 5$ (I’m a size 6/M)" ],
       ...
       "i miss home (england)- let's have somethin’ to remind me of my city", 
